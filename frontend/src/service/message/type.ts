...
export type GraphOdataError =
	components["schemas"]["microsoft.graph.ODataErrors.ODataError"];
export type GraphMainError =
	components["schemas"]["microsoft.graph.ODataErrors.MainError"];
